...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <center><table width="45%" style="margin-bottom: 20px;">
        <tbody style=" border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;"><br><br><br><br><br><br><br>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">IMAGES</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Name</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Area</th>
            @foreach($allImages as $rec)
                <tr>
                    
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;"><img src="upload/gallery/{{$rec->img}}" height='150px' width='200px'></td>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;"> {{$rec->name}}</td>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;"> {{$rec->area}}</td>
                </tr>
