...
<form id="feedback" method="post" action="{{route('store_review')}}">
	@csrf
...
<div class="form-group">
  ...
  <textarea class="form-control" id="review" name="feed" rows="3"></textarea>
 ...
 <a href="https://www.instagram.com/darsh.patel.27/"><i class="fa fa-instagram"></i>&nbsp;join us on instagram</a>
</form>
