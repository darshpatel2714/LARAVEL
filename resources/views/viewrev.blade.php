...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <img  src="https://nofoodwaste.org/images/NFW-logo.png" style="height: 100px;">
    </a>
<br>
    <!-- Divider -->
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="/view" data-toggle="collapse" data-target="/view"
            aria-expanded="true" aria-controls="collapseTwo">
            <!-- <i class="fas fa-fw fa-cog"></i> -->
            <span style="font-size: 15px;">user's login</span>
        </a>
      

    <!- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="/reviewadmin" data-toggle="collapse" data-target="/reviewadmin"
            aria-expanded="true" aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-wrench"></i>
            <span>user's review</span>
        </a>
    ...
    <!-- Heading -->
    <div class="sidebar-heading">
        <p style="font-size: 25px;">DONATE</p>
    </div>

    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="/image" data-toggle="collapse" data-target="/image"
            aria-expanded="true" aria-controls="collapsePages">
            <i class="fas fa-fw fa-folder"></i>
            <span style="font-size: 15px;">user's donate view</span>
        </a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="log.html" data-toggle="modal" data-target="#logoutModal">
       ...
       <center> <table>
        <tbody>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Name</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Email</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Rate</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Feed</th>
            <th style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">Action</th>
            
            @foreach($allrecords as $rec)
                <tr>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">{{$rec['name']}}</td>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">{{$rec['email']}}</td>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">{{$rec['rate']}}</td>
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;">{{$rec['feed']}}</td>
                
                    
                    <td style="color: black;  border: 1px solid black;border-radius: 10px;padding: 15px;text-align: center;"><a href="{{url('del/'.$rec->id)}}">Delete</a></td>
                </tr>
            @endforeach
        </tbody>
    </table></center>
